	...
	<div class="wrapper">
        ...
        <form class="row g-3" method="POST" action="{{ route('login') }}">
            ...
            <div class="col-12">
                ...
                <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="visionmentors@gmail.com">
                @error('email')
            ...
            <div class="col-12">
                <div class="text-center ">
                    <p class="mb-0">Don't have an account yet? <a href="authentication-signup.html">Sign up here</a>
									...
									<a href="https://www.facebook.com/visionmentorsvn" class="list-inline-item bg-facebook text-white border-0 rounded-3"><i class="bx bxl-facebook"></i></a>
